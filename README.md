...
published image (`ghcr.io/kristijorgji/testproof:0.4.13`) from a compose file
...
services:
  postgres:
    ...
    healthcheck:
      ...
      retries: 10
  web:
    image: ghcr.io/kristijorgji/testproof:0.4.13
    ports:
...
Program name `testproof`, version `0.4.13`. Unhandled errors print to stderr and
exit `1`.
...
`ghcr.io/kristijorgji/testproof:0.4.13` (linux/amd64 and linux/arm64). Do not
